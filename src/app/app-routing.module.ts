...
const routes: Routes = [
  ...
  {path: 'home', loadComponent: () =>
      import('src/app/pages/home/home.component')
        .then(m => m.HomeComponent)},
  {path: 'estoque-vendas', loadComponent: () =>
      import('src/app/pages/inventory-reversals/inventory-reversals.component')
        .then(m => m.InventoryReversalsComponent)},
  {path: 'estoque-total', loadComponent: () =>
      import('src/app/pages/inventory-total/inventory-total.component')
        .then(m => m.InventoryTotalComponent)},
